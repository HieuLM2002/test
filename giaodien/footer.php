...
<footer class="section-p1"><!--mục footer -->
    ...
    <div class="col">
        ...
        <p>Liên hệ CSKH: support@<a href ="#"> link Website </a></p>
        <p>For business: contact@<a href ="#"> link Website </a></p>
    </div>
    <div class="col">
        ...
        <li><i class="fa fa-youtube"></i>:<a href="https://www.youtube.com/channel/UCyxnPi9rA4LLW-Gex1AK5RA">  BopBop</a></li>            
    </div>   

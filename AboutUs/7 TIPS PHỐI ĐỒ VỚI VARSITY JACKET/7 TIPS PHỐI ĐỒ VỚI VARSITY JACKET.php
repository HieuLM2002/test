...
<!-----------------------HEARDER ----------------------------------------->
<header>
<a href="/Project_shop_clothes/giaodien/index.php"><img src="/Project_shop_clothes/images/avt.png" class="logo" style="width:130px;"><!--LOGO --></a>
...
<ul id="list-new">
    ...
    <div class="box-left" >
        <a href="../Dirtycoins/Dirtycoins.php"><button>Xem thêm </button><!--nút mua hàng --></a>
    </div>   
    <div class="item"><!--sản phẩm 1 -->

...
<head>
  ...
  <link rel="shortcut icon" type="image/png" href="/Web_eprojectn3/admin/product/uploads/avt3.png"/>
...
<a href="../giaodien/index.php"><img src="/Project_shop_clothes/images/avt.png" class="logo" style="width:130px;"><!--LOGO --></a>
  ...
  <div id="menu" style="margin-top:10px;">
        ...
        <div class="other"><!--Other -->
                ...
                if(isset($_SESSION['submit'])) {
                    $user_admin = $_SESSION['submit'];
                            if($user_admin == 'Admin_Chu') {
                             ...
                             echo '<a href="/Project_shop_clothes/login.php"">Đăng nhập</a>';
                                }
                ?>
            ...
            <li><a href="/Project_shop_clothes/cart.php" style="text-decoration:none; " ><i class="fas fa-shopping-bag"></i></a> <?php
                        $cart = [];
...
<ul id="list-new">
    ...
    <div class="box-left" >
        <a href="../7 TIPS PHỐI ĐỒ VỚI VARSITY JACKET/7 TIPS PHỐI ĐỒ VỚI VARSITY JACKET.php"><button>Xem thêm </button><!--nút mua hàng --></a>
    </div>   
    ...
    <div class="box-left" >
        <a href="../THÔNG TIN CHƯƠNG TRÌNH/THÔNG TIN CHƯƠNG TRÌNH.php"><button>Xem thêm </button><!--nút mua hàng --></a>
    </div>       
</ul>
</html>
